...
fn test_example_1() {
    ...
    let expected = Feed::new(FeedType::JSON)
        ...
        .title(Text::new("Daring Fireball"))
        ...
        .entry(Entry::default()
            .title(Text::new("How Jeff Bezos’s iPhone X Was Hacked"))
            ...
            .content(Content::default()
                ...
                .length(177)))
        .entry(Entry::default()
            .title(Text::new("Instagram for Windows 95"))
...
fn test_spec_1() {
    ...
    let expected = Feed::new(FeedType::JSON)
        .id(&actual.id)                 // not in test content
        .updated(actual.updated)        // not in test content
        .title(Text::new("JSON Feed"))
        .description(Text::new("JSON Feed is a pragmatic syndication format for blogs, microblogs, and other time-based content."))
        ...
        .entry(Entry::default()
            ...
            .title(Text::new("Announcing JSON Feed"))
...
fn test_elastic_v1_1() {
    ...
    let entry = entries.next().unwrap();
    assert_eq!(entry.authors, vec![chris]);
